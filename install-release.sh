...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/v2xu/V2Ray-With-SSpanel/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
    echo ${DOWNLOAD_LINK}
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/v2xu/V2Ray-With-SSpanel/releases/latest"
